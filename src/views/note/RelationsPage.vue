...
const fetchData = async (params = {}) => {
	...
	try {
		...
		const response = await apiClient.get(`u/notes/${noteId}/relations`, {
			params: formatParams
		});

		dataSource.value = response.data.data.relations || [];
...
const columns = computed(() => [
	...
	},
	{
		...
		filters: [
			...
			{ text: 'Newbie', value: 'newbie' },
		],
		sortOrder: sortedInfo.value.columnKey === 'hardLevel' && sortedInfo.value.order,
	},
]);
...
const handleSearch = (selectedKeys, confirm, dataIndex) => {
	...
	let constTextIndex = ["title", 'shortText'];
